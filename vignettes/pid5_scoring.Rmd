...
The published tables cover the five domain scales and the four validity scales for the full form; they do not cover the 25 facets. Each converted scale gains a `_ptl` column, and those whose tables print T scores also gain a `_t` column. The four validity scales are distributed as percentiles only, so they get no `_t` column.
