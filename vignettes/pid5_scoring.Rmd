...
For the full form the published tables cover the five domain scales and three of the validity scales — INC, ORS, and PRD. They do not cover the 25 facets, and they do not cover SD-TD at all. Each converted scale gains a `_ptl` column, and those whose tables print T scores also gain a `_t` column. The validity scales are distributed as percentiles only, so they get no `_t` column.
