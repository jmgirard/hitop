...
Set `target = "scales"` to label the output of `score_hitopbr()` instead. Here the prefix is the one the scoring function put on its output columns, which is `"hbr_"` by default:
