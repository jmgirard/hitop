...
build_notes <- paste(
  "One scale is named Appearance Focus on the scoring page, where it was",
  "previously named Body Focus. Item text, item numbers, response options,",
  "and every other scale name are unchanged."
)
