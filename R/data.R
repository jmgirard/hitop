...
#'   validity scales, an item sum. Nineteen facet columns print raws above the
#'   3.00 a mean of 0-3 items can reach, up to 4.00; those rows ship as
#'   published and are simply unattainable (see [norm_pid5()])}
