...
value, and the points are joined by a profile line. A single reference
line marks the normative sample's midpoint – T = 50, or the 50th
percentile. Both are definitional properties of the metrics themselves
rather than thresholds this package chose.
