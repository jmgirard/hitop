...
- AC5 (CI half): hitop-builder PR #19 (https://github.com/jmgirard/hitop-builder/pull/19), head 7df52a9 with the fix-now commit, smoke check passed in 50s. After the fixes, local smoke also passed (1 passed). Pass.
