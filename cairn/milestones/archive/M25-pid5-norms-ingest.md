...
**Decisions:** M25-D1 a committed extractor replaces the planned fresh-reader
transcription. M25-D2 the 18-cell correction ledger with IP1 sign-off. M25-D3/D4 keep
`INC` ([D-018](../../DECISIONS.md)) and record PID-5-PRD, not "PIM-RD". M25-D5 fixes the
