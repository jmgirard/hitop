...
`low × nItems` for `PRD` (count read from `pid_items`), 0 otherwise, before the untouched M27
...
**Review:** Three lenses; prior-review found nothing and confirmed M27's five fixes intact,
