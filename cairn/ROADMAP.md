...
_Last hygiene check: 2026-07-31 (M31 planned, absorbing both of M30's residue candidates — the norming differential oracle and the shared validator polish — whose rows are removed; the candidate row's `.internal = TRUE` item was dropped at the plan gate as having no referent in `R/util.R`)_
...
|---|---|---|---|---|---|
| M31 | Argument-validation consistency and a harder norming oracle | in-progress | — | normal | milestones/M31-validator-and-oracle-residue.md |
