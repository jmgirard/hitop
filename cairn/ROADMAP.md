...
_Pre-migration history: see `cairn/legacy/` and git log (M1–M17 done there; IDs continue — next new milestone is M19)._

## Milestones

| ID | Title | Status | Depends on | Priority | File/Archive |
|---|---|---|---|---|---|
| M18 | HiTOP-HSUM source alignment (revised SUD module, Aug 2024) | planned | — | normal | milestones/M18-hsum-source-alignment.md |
