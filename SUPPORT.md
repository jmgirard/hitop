...
Thanks for using hitop! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/jmgirard/hitop/issues/new).
...
requests](https://github.com/jmgirard/hitop/issues) to make sure the bug
