...
The full HiTOP-PRO has 405 items and yields 76 scale scores. We can demonstrate the ability of the `score_hitop_pro()` function to calcualte these scores using real data that was collected at the University of Kansas (KU).
