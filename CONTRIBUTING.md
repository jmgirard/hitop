...
This outlines how to propose a change to hitop. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("jmgirard/hitop", fork = TRUE)`.
...
Please note that the hitop project is released with a [Contributor Code
of Conduct](https://jmgirard.github.io/hitop/CODE_OF_CONDUCT.md). By
